...
9) Payload Integrity
Compute and verify SHA-256 over KERNEL.md + canonical IDENTITY.json. Refuse silent REGENERATE_ON_EXPORT placeholders.

10) Evolution Gates
Protected constitution files land in proposals/ unless explicitly applied. chorus/*.py changes prefer a paired test.
